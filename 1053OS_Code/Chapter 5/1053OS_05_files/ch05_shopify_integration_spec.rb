...
describe ShopifyIntegration do
  ...
  context "create_charge" do
    before do
      ...
      @test_charge_response = OpenStruct.new(activated_on: nil,
                                      api_client_id: 123456,
                                      billing_on: nil,
                                      cancelled_on: nil,
                                      created_at: "2014-04-23T11:41:32-04:00",
                                      id: 1231231,
                                      name: "Recurring Charge",
                                      price: "10.00",
                                      return_url: "http://test.return.url/go",
                                      status: "pending",
                                      test: true,
                                      trial_days: 0,
                                      trial_ends_on: nil,
                                      updated_at: "2014-04-23T11:41:32-04:00",
                                      decorated_return_url: "http://test.return.url/go?charge_id=1234567",
                                      confirmation_url: "http://test.myshopify.com/admin/charges/1234567/confirm_recurring_application_charge?signature=BAhpBHkQASc%3D--91658c571612d73c68d12a0196801a242a8440ce"
                                      )


      @real_charge_response = OpenStruct.new(activated_on: nil,
                                      api_client_id: 123456,
                                      billing_on: nil,
                                      cancelled_on: nil,
                                      created_at: "2014-04-23T11:41:32-04:00",
                                      ...
                                      updated_at: "2014-04-23T11:41:32-04:00",
                                      decorated_return_url: "http://test.return.url/go?charge_id=1234567",
                                      confirmation_url: "http://real.myshopify.com/admin/charges/1234567/confirm_recurring_application_charge?signature=BAhpBHkQASc%3D--91658c571612d73c68d12a0196801a242a8440ce"
                                      )
    end

    it "should create a test recurring charge and return the confirmation url" do

      ShopifyAPI::RecurringApplicationCharge.should_receive(:create).with({
        name: "Contest App Paid Membership",
        price: 10.00,
        return_url: "#{DOMAIN}/shopify/confirm", 
        test: true
        }).and_return(@test_charge_response)
     
      @shopify_integration.create_charge(10,true).should == "http://test.myshopify.com/admin/charges/1234567/confirm_recurring_application_charge?signature=BAhpBHkQASc%3D--91658c571612d73c68d12a0196801a242a8440ce"

    end

    it "should create a real recurring charge and return the confirmation url" do
      ...
      ShopifyAPI::RecurringApplicationCharge.should_receive(:create).with({
        ...
        return_url: "#{DOMAIN}/shopify/confirm", 
        test: nil
        }).and_return(@real_charge_response)
     
      @shopify_integration.create_charge(10,false).should == "http://real.myshopify.com/admin/charges/1234567/confirm_recurring_application_charge?signature=BAhpBHkQASc%3D--91658c571612d73c68d12a0196801a242a8440ce"
